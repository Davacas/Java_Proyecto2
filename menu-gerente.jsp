...
%>
	...
	<!--fin del navbar-->
        ...
        <p><h3>Bienvenido, <%=session.getAttribute("id_empleado")%></h3></p>
        <p><a href="admin-meseros.jsp"class="waves-effect waves-light btn blue-grey lighten-2">Administrar meseros</a></p>
        <p><a href="admin-platillos.jsp" class="waves-effect waves-light btn blue-grey lighten-2">Administrar platillos</a></p>
